...
use App\Http\Controllers\App\Panel\‌GalleryController as Panel‌GalleryController;
...
Route::prefix('panel')->name('panel.')->middleware(['auth:sanctum', 'mobileVerified'])->group(function () {
    Route::prefix('advertise')->name('advertise.')->group(function () {
        ...
        Route::prefix('gallery')->name('gallery.')->group(function () {
            Route::get('{advertisement}/', [Panel‌GalleryController::class, 'index'])->name('index');
            Route::post('{advertisement}/store', [Panel‌GalleryController::class, 'store'])->name('store');
            Route::get('show/{gallery}', [Panel‌GalleryController::class, 'show'])->name('show');
            Route::put('/{gallery}', [Panel‌GalleryController::class, 'update'])->name('update');
            Route::delete('/{gallery}', [Panel‌GalleryController::class, 'destroy'])->name('destroy');
        });
